...
public class Store {
    ...
    public void runDay() {
        ...
        if (getDay() % 7 == 0) {
            ...
            System.out.println("ORDERS PRE APPEND");
            for (Item i : orders) {
                System.out.print(i.getName() + ", ");
            }
            System.out.println("END ORDERS PRE APPEND");
            // orders.addAll(newOrders);
            orders = newOrders;
            System.out.println("ORDERS POST APPEND");
            for (Item i : orders) {
                System.out.print(i.getName() + ", ");
            }
            System.out.println("END ORDERS POST APPEND");
